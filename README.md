...
### Dashboard Page
- Company net cash and capital metrics  
- Interactive pie charts and bar charts  
- Embedded Metabase analytics  

### Branch Dashboard
- Branch-specific cash balance  
- Branch-level analytics  
- Filtered dashboard view  

### AI Model Predictions
- Stress Level Score (Low / Moderate / High)  
- Risk Probability (%)  
- Survival Horizon (Months Estimate)  
- Liquidity Warning Alerts  
